...
//User Data
const pinCode: number = 4564;
const currectBalance: number = 50000;
...
if (loginWithPin.pin === pinCode){
  ...
  const Services = await inquirer.prompt([
    ...
    {// Fast Cash with limited options of cash
      name: "fastCash",
      type: "list",
    ...
    {// Cash Withdrawal without not limited options  
      name: "cashWithdrawal",
      type: "input",
    ...
    {// Fund Transfer - select your Bank and transfer your amount
      name: "selectbank",
      type: "list",
    ...
    {// type of transfer list ( account or IBAN )
    ...
    {// transfer your amount with account number
    ...
    {// transfer your amount with IBAN number
  ...
  else {console.log("This is not correct pin");
